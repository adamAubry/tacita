...
/**
 * REQ-INV-02 — 256 bits tirés d'un CSPRNG. `base64url` : rien à échapper dans une URL,
 * donc rien qui se perde à la copie d'un lien.
 *
 * Pas de jeton auto-porteur signé (JWT) : un JWT ne se révoque pas, et REQ-INV-05 exige
...
/**
 * REQ-INV-02 — le token n'est jamais stocké en clair : une base qui fuite ne donne
 ...
 * authentifié ferait de REQ-INV-09 un levier de déni de service au lieu d'une défense.
 */
