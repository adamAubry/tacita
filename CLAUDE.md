...
- `DECISIONS.md` — arbitrages produit tranchés (**D-01 à D-14**). Ne pas les rediscuter dans le code ; escalader au PM. Une entrée peut aussi porter des **notes de conception** non normatives et des **points ouverts** — elle le dit alors en tête. *(Étendu le 20/08/2026 ; D-11 à D-14 tranchées les 20 et 25/08/2026.)*
